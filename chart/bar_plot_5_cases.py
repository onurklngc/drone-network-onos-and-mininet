...
plt.bar(x - 2 * width, only_cloud, width, color=cb_color_cycle[4])
plt.bar(x - width, agg_1, width, color=cb_color_cycle[0], hatch='\\')
plt.bar(x, agg_2, width, color=cb_color_cycle[1])
plt.bar(x + width, adp, width, color=cb_color_cycle[2], hatch='/')
plt.bar(x + 2 * width, q_opt, width, color=cb_color_cycle[3], hatch='/')
