...
def topology():
    ...
    ap2 = net.addAccessPoint('ap2', wlans=4, ssid='ssid2', channel=10, position='600,100,0')
    ap3 = net.addAccessPoint('ap3', wlans=3, ssid='ssid3', channel=11, position='900,100,0')
    ap4 = net.addAccessPoint('ap4', wlans=3, ssid='ssid4', channel=8, position='600,300,0')
    ...
    h4 = net.addHost('h%d' % 4, mac='00:00:00:00:00:' + hex(3).split('x')[-1].zfill(2))
    ...
    net.addLink(h4, ap4, bw=100, delay='0ms')
    ...
    net.addLink(ap2, intf='ap2-wlan4', cls=mesh, ssid='mesh-ssid24', channel=4, ht_cap='HT40+')
    net.addLink(ap4, intf='ap4-wlan2', cls=mesh, ssid='mesh-ssid24', channel=4, ht_cap='HT40+')
    ...
    # h1.popen('iperf -s -i 1')
    # h2.popen('iperf -s -i 1')
    # h3.popen('iperf -s -i 1')
