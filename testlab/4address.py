...
def topology(args):
    ...
    sta5 = net.addStation('sta5', ip="192.168.0.5/24", position='81,22,0')
    sta6 = net.addStation('sta6', ip="192.168.0.6/24", position='82,24,0')
    ...
    # net.addLink(ap2, ap3, cls=_4address)  # ap1=ap, ap3=client
