...
def topology():
    ...
    ap1 = net.addAccessPoint('ap1', wlans=2, ssid='ssid1', channel=9, position='310,100,0')
    ap2 = net.addAccessPoint('ap2', wlans=2, ssid='ssid2', channel=10, position='600,100,0')
    ap3 = net.addAccessPoint('ap3', wlans=2, ssid='ssid3', channel=11, position='900,100,0')
    ...
    net.addLink(ap1, intf='ap1-wlan2', cls=mesh, ssid='mesh-ssid', channel=4, ht_cap='HT40+')
    net.addLink(ap2, intf='ap2-wlan2', cls=mesh, ssid='mesh-ssid', channel=4, ht_cap='HT40+')
    net.addLink(ap3, intf='ap3-wlan2', cls=mesh, ssid='mesh-ssid', channel=4, ht_cap='HT40+')
